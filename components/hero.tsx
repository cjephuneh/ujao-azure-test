        ...
        <h1 className="text-4xl md:text-4xl lg:text-5xl mt-[200px] font-extrabold text-white mb-4 tracking-wide">
          ...
          <div className="">
            <input
              ...
              className="w-[350px] rounded border border-gray-300 shadow-sm p-4 focus:border-gtahidiPink focus:ring focus:ring-gtahidiPink focus:ring-opacity-50"
            />
          </div>
          <button 
            className="mt-8 border-white text-white font-bold py-2 px-4 rounded border" 
          >
            Get Started
          </button>
